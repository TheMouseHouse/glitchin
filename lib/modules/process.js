...
var effect_provider_1 = require("./effect-provider");
...
function Process(image, mime, effects) {
    return new Promise(function (resolve, reject) {
        ...
        if (!lodash_1.isNil(effects) && effects.length > 0) {
            logger_1["default"]('log', 'Applying effects...');
            lodash_1.each(effects, function (effect) {
                logger_1["default"]('log', effect);
                glitch = effect_provider_1["default"](effect, glitch);
            });
        }
        resolve(glitch);
    });
